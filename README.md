...
* **HTML5 Foundations**: Structured forms, layouts, and DOM element targeting.
* **JavaScript Essentials**:
  * Core Syntax, Variables, and Data Types
  * Functions, Scope, and Logic Control
  * Event Handling and DOM Manipulation
  * Revision exercises for progressive learning across classes
...
* **Frontend**: HTML5 (86.7%)
* **Scripting**: JavaScript (13.3%)
* **Development Tools**: VS Code, Web Browsers (Chrome/Firefox), Git & GitHub
